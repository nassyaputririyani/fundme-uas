          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="card-people" style="padding: 60px">
                      <img src="{{ asset('images/img_naufal.png') }}" style="border-top-left-radius: 10px; border-top-right-radius: 10px;" class="w-100 h-80" alt="Promo">
                      <div class="container px-4 pt-4 py-2 text-center">
                          <h3>
                              Naufal Fawwaz
                              Andriawan
              ...
              <div class="col-md-4">
                  <div class="card-people" style="padding: 60px">
                      <img src="{{ asset('images/img_nassya.png') }}" style="border-top-left-radius: 10px; border-top-right-radius: 10px;" class="w-100 h-80" alt="Promo">
                      <div class="container px-4 pt-4 py-2 text-center">
                          <h3>
                              Nassya Putri
                              Riyani
              ...
              <div class="col-md-4">
                  <div class="card-people" style="padding: 60px">
                      <img src="{{ asset('images/img_ijah.png') }}" style="border-top-left-radius: 10px; border-top-right-radius: 10px;" class="w-100 h-80" alt="Promo">
                      <div class="container px-4 pt-4 py-2 text-center">
                          <h3>
                              Azzahra Ayu
                              Vahendra
